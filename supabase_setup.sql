...
-- 6. TABLE ACTIVITIES (Activités, Visites, Formations & Événements)
CREATE TABLE IF NOT EXISTS public.activities (
  ...
  type TEXT DEFAULT 'event' CHECK (type IN ('event', 'visit', 'formation')),
  ...
  capacity INTEGER,
  status TEXT DEFAULT 'published' CHECK (status IN ('draft', 'published', 'archived', 'cancelled', 'done')),
