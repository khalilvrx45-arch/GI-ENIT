...
export default function InvitePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const handleAccept = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Insert/Update Profile record if user created
      if (authData.user) {
      ...
      const targetRoute = invitation.role === "membre_bureau" ? "/bureau" : "/dashboard";
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      >
        ...
        {statusState === "expired" && (
          <div className="bg-[#14213d]/90 border border-[#333535] rounded-3xl p-8 sm:p-12 text-center shadow-2xl backdrop-blur-xl">
        ...
        {statusState === "invalid" && (
          <div className="bg-[#14213d]/90 border border-[#333535] rounded-3xl p-8 sm:p-12 text-center shadow-2xl backdrop-blur-xl">
            ...
            <p className="text-sm text-[#a0a0a0] mb-8 leading-relaxed">
              Ce lien n'existe pas ou a été annulé.
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-custom-amber text-black font-bold text-sm hover:bg-[#ffc887] transition-colors"
