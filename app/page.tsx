  ...
  return (
    <div className="bg-black text-custom-gray overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(20,33,61,0.25)_1px,transparent_1px),linear-gradient(to_bottom,rgba(20,33,61,0.25)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] z-0" />
        
        {/* Amber Glow Accent */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-custom-amber/5 blur-[120px] pointer-events-none z-0" />
        ...
        >
          ...
          <motion.div 
            variants={fadeInUp}
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-custom-navy border border-custom-amber/20 text-custom-amber text-xs font-semibold uppercase tracking-wider shadow-[0_0_15px_rgba(252,163,17,0.1)]"
          >
            <div className="w-5 h-5 rounded-full overflow-hidden border border-custom-amber/30 flex-shrink-0">
              <img src="/logo-cgi.jpg" alt="CGI" className="w-full h-full object-cover" />
            </div>
          ...
          <motion.h1 
            variants={fadeInUp}
            className="text-4xl sm:text-6xl md:text-7xl font-extrabold text-custom-white tracking-tight leading-tight"
          >
            Live Your Best <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-custom-amber via-yellow-500 to-amber-600">
              Experiences
            </span>
          </motion.h1>
          ...
          <motion.p 
            variants={fadeInUp}
            className="text-lg sm:text-xl text-custom-gray/70 max-w-2xl mx-auto leading-relaxed"
          >
      ...
      <section id="activities" className="py-24 bg-black border-t border-custom-navy/20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div 
          ...
          >
            ...
            <p className="text-sm text-custom-gray/60 leading-relaxed">
              Nous construisons des opportunités réelles d'apprentissage pour nos membres grâce à nos quatre principaux types d'activités.
            </p>
          </motion.div>
          ...
          >
            {activities.map((act, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={cardHoverEffect}
                className="bg-custom-navy p-8 rounded-3xl border border-custom-gray/10 transition-all duration-300 group flex gap-6 items-start cursor-pointer"
              >
                <div className="w-16 h-16 rounded-2xl bg-black flex items-center justify-center flex-shrink-0 border border-custom-gray/10 group-hover:border-custom-amber/30 transition-colors">
                  {act.icon}
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <h3 className="text-custom-white font-extrabold text-lg sm:text-xl tracking-wide group-hover:text-custom-amber transition-colors">
                      {act.title}
                    </h3>
                    <span className="text-[9px] font-mono font-semibold uppercase tracking-widest text-custom-amber bg-custom-amber/10 px-2 py-0.5 rounded-md">
                      {act.tag}
                    </span>
                  </div>
                  <p className="text-custom-gray/70 text-sm leading-relaxed">
